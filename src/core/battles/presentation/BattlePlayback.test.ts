...
function frame(index: number, at: number, phase: BattlePresentationFrame['phase']): BattlePresentationFrame {
  return {
    ...
    lossesThisFrame: {},
    sides: {
      A: { factionId: 'a', initialUnits: 10, units: 10, morale: 80, totalLosses: 0, initialRoster: { line: 10 }, roster: { line: 10 }, broken: false, outcome: null, initialSectorState: { sectors: { left: { units: 2, morale: 80, broken: false, posture: 'engage' }, center: { units: 6, morale: 80, broken: false, posture: 'engage' }, right: { units: 2, morale: 80, broken: false, posture: 'engage' } }, reserveUnits: 0, reserveCommitted: true }, sectorState: { sectors: { left: { units: 2, morale: 80, broken: false, posture: 'engage' }, center: { units: 6, morale: 80, broken: false, posture: 'engage' }, right: { units: 2, morale: 80, broken: false, posture: 'engage' } }, reserveUnits: 0, reserveCommitted: true } },
      B: { factionId: 'b', initialUnits: 10, units: 10, morale: 80, totalLosses: 0, initialRoster: { line: 10 }, roster: { line: 10 }, broken: false, outcome: null, initialSectorState: { sectors: { left: { units: 2, morale: 80, broken: false, posture: 'engage' }, center: { units: 6, morale: 80, broken: false, posture: 'engage' }, right: { units: 2, morale: 80, broken: false, posture: 'engage' } }, reserveUnits: 0, reserveCommitted: true }, sectorState: { sectors: { left: { units: 2, morale: 80, broken: false, posture: 'engage' }, center: { units: 6, morale: 80, broken: false, posture: 'engage' }, right: { units: 2, morale: 80, broken: false, posture: 'engage' } }, reserveUnits: 0, reserveCommitted: true } },
    },
  };
}
